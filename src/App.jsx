...
// import GitHubProfile from "./pages/GitHubProfile"; // Temporarily disconnected
...
import Login from "./pages/Login"; // ✅ Login Page Imported
...
function App() {
  return (
    <Routes>
      ...
      {/* <Route path="/githubcompare" element={<GitHubCompare />} /> */}
